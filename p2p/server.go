...
import (
	...
	"github.com/winstonprivacyinc/go-ethereum/common"
	"github.com/winstonprivacyinc/go-ethereum/common/mclock"
	...
	"github.com/winstonprivacyinc/go-ethereum/p2p/discover"
	"github.com/winstonprivacyinc/go-ethereum/p2p/discv5"
	"github.com/winstonprivacyinc/go-ethereum/p2p/enode"
	"github.com/winstonprivacyinc/go-ethereum/p2p/enr"
	"github.com/winstonprivacyinc/go-ethereum/p2p/nat"
...
func (srv *Server) setupDiscovery() error {
	...
	if srv.DiscoveryV5 {
		...
		//fmt.Println("[DEBUG] setupDiscovery() Listening on disc v5")
...
func (srv *Server) run(dialstate dialer) {
	srv.log.Info("Started P2P Server", "self", srv.localnode.Node().ID().TerminalString())
	defer srv.loopWG.Done()
...
func (srv *Server) Closest(targetID enode.ID, nresults int) ([]*enode.Node) {
	if srv.ntab != nil {
